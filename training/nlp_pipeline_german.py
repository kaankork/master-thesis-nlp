...
class NLP_pipeline:
    ...
    def __init__(self,
        ...
        self.mlm_translation_direct = mlm_translation_direct
    ...
    def load_data(self):
        ...
        df_train = pd.read_csv('/home/kaan/mamma-reports_cleaned/train_val_test/train.csv',
                               index_col=0).reset_index(drop=True)
        df_val = pd.read_csv('/home/kaan/mamma-reports_cleaned/train_val_test/val.csv',
                             index_col=0).reset_index(drop=True)
        df_test = pd.read_csv('/home/kaan/mamma-reports_cleaned/train_val_test/test.csv',
                              index_col=0).reset_index(drop=True)
    ...
    def initialize_model_and_tokenizer(self,
        ...
        # Manually setting the size of the classification layer
        # This is needed because pretrained models have various num_labels
        # Source - https://discuss.huggingface.co/t/how-do-i-change-the-classification-head-of-a-model/4720/11
        # print("classifier before: {}".format(self.model.classifier))
        # print("model before: {}".format(self.model))
        # self.model.classifier = torch.nn.Linear(in_features=768, out_features=self.num_labels)
        # print("classifier after: {}".format(self.model.classifier))
        # print("model after: {}".format(self.model))
    ...
    def training_argument_creator(self,
        ...
        Stores the variables in self.
        """
        self.output_dir = '/home/kaan/code/model_training/trained/german_model_results/germanModelResults_{}_{}_{}epochs_{}lrType'.format(d1, self.model_name,self.num_training_epochs,self.lr_scheduler_type)
    ...
    def make_prediction(self):
        ...
        self.test_results = {"accuracy": self.test_metric.compute(predictions=preds, references=predictions.label_ids),
                             ...
                             "roc_auc_score": roc_auc_score(y_score=softmax(predictions.predictions, axis=1),
                                                            y_true=predictions.label_ids, multi_class="ovo",
                                                            average="macro"),
        ...
        self.test_results_as_list = ['nlp_pipeline_german',
                                     ...
                                     self.test_results["f1_micro"]["f1"],
                                     self.test_results["f1_macro"]["f1"],
                                     self.test_results["precision"]["precision"],
                                     self.test_results["recall"]["recall"],
                                     self.test_results["top_3_accuracy"],
                                     self.test_results["top_5_accuracy"],
                                     self.test_results["roc_auc_score"],
    ...
    def visualize_confusion_matrix(self,
        ...
        if save_image:
            if len(self.output_dir) > 100:
                ...
                start_index = 39
            plt.savefig(
                fname=f'/home/kaan/results/confusion_matrix_images/denormalized/denormalized_{self.output_dir[start_index:].replace("/", "-")}.jpeg')
    ...
    def visualize_confusion_matrix_normalized(self,
        ...
        if save_image:
            if len(self.output_dir) > 100:
                ...
                start_index = 39
            plt.savefig(
                fname=f'/home/kaan/results/confusion_matrix_images/normalized/normalized_{self.output_dir[start_index:].replace("/", "-")}.jpeg')



# Enter the model names or checkpoint paths in the models_to_test list
# If you're testing checkpoints make sure to set loaded_from_checkpoint=True while initializing the NLP Pipeline object
models_to_test = [
    # 'bert-base-german-cased',
    #               'bert-base-german-dbmdz-uncased',
    '/home/kaan/code/model_training/trained/mlm_training_results/bert-base-german-cased_cpg-sentences_50-epochs/checkpoint-90000',
    # '/home/kaan/code/model_training/trained/mlm_training_results/bert-base-german-cased_gmw-sentences_50-epochs/checkpoint-95000',
    # '/home/kaan/code/model_training/trained/mlm_training_results/englishModelAdaptedWithGermanCorpus_emilyalsentzer/Bio_ClinicalBERT_cpg-sentences_50-epochs/checkpoint-145000',
    # 'bert-base-multilingual-uncased',
    # 'bert-base-multilingual-cased',
    # '/home/kaan/code/model_training/trained/mlm_training_results/englishModelAdaptedWithGermanCorpus_emilyalsentzer/Bio_ClinicalBERT_gmw-sentences_50-epochs/checkpoint-165000',
]

# Enter the number of epochs for fine-tuning
epochs_to_test = [10]
...
for model in models_to_test:
    for epoch in epochs_to_test:
        pipe_object = NLP_pipeline(
            ...
            mlm_dataset='cpg',
            mlm_translation_direct='german+mlm'
        )
